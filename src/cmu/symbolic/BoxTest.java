...
public class BoxTest {
	...
	public static Box createBox(double startLat, double startLon, double endLat, double endLon, double leftWidth, double rightWidth) {
	...
	public static void setWidths(double startLat, double startLon, double endLat, double endLon, double leftWidth, double rightWidth, double newLeftWidth, double newRightWidth) {
		Box box = createBox(startLat, startLon, endLat, endLon, leftWidth, rightWidth);
